...
CREATE TABLE IF NOT EXISTS user_profiles (
    ...
    telegram_id VARCHAR(100) NULL COMMENT 'Telegram user ID',
    discord_id VARCHAR(100) NULL COMMENT 'Discord user ID',
...
-- Creator commission accumulation table - 创作者佣金累积表
